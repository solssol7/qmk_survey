...
window.QUIZ_DATA = (() => {
    ...
    const TYPES = {
      "PVE": { name:"장보기 PM(프로젝트 매니저)", one:"필요한 것만 정확히, 빠르게 사는 타입이에요.",
      ...
      "PVB": { name:"냉정한 단가 헌터", one:"특가/대용량에서 이득을 잘 보는 타입이에요.",
      ...
      "PQE": { name:"맛잘알 성분감별사", one:"검증된 인기템 위주로 만족도를 챙기는 타입이에요.",
      ...
      "PQB": { name:"브랜드 충성 VIP", one:"내가 좋아하는 걸 ‘확실하게’ 사는 타입이에요.",
      ...
      "IVE": { name:"행사 코너 자석 인간", one:"행사만 보면 마음이 움직이는 타입이에요.",
      ...
      "IVB": { name:"1+1에 인생 건다", one:"묶음딜에 강한 ‘합리적 충동’ 타입이에요.",
      ...
      "IQE": { name:"신상 시식단", one:"새로 나온 것부터 보는 타입이에요.",
      ...
      "IQB": { name:"오늘의 미식 대장정", one:"요리 생각에 장바구니가 커지는 타입이에요.",
